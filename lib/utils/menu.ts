...
export function groupMenuItems<T extends MenuItemLike>(items: T[]): MenuItemGroup<T>[] {
...
export function sortMenuItemsByType<T extends MenuItemLike & { price: number | string }>(
  items: T[]
): T[] {
